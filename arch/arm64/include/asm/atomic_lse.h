...
{									\
	return add_wrap(int, __lse_atomic_fetch_add##name(i, v), i);	\
}									\
									\
static __always_inline int						\
__lse_atomic_sub_return##name(int i, atomic_t *v)			\
{									\
	return sub_wrap(int, __lse_atomic_fetch_sub(i, v), i);		\
}
...
{									\
	return add_wrap(s64, __lse_atomic64_fetch_add##name(i, v), i);	\
}									\
									\
static __always_inline long						\
__lse_atomic64_sub_return##name(s64 i, atomic64_t *v)			\
{									\
	return sub_wrap(s64, __lse_atomic64_fetch_sub##name(i, v), i);	\
}
